...
object UnitTesting extends App {
  ...
  s"$dash10 The MUnit Package $dash10".magenta.println()

  // The doobie-munit add-on provides a mix-in trait that we can add to any Assertions implementation
  // (like FunSuite) much like the ScalaTest package above.
